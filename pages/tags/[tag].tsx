...
const TagDetail = (props: ITagDetailProps) => {
  ...
  return (
    <PageLayout>
      <section className="mt-5 flex flex-col h-full">
        <section><Tag name={props.tag} showStyle className="mb-3 py-1" /></section>
        <section className="p-6 bg-white rounded-lg flex-1">
